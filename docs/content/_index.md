---
title: "sbdi"
description: "A command line for sbdi."
heroTitle: "sbdi, from the command line"
heroLead: "A command line for sbdi. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
sbdi links <path>           # the pages it links to, each addressable
sbdi serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading sbdi by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address sbdi as
  `sbdi://` URIs and follow links across sites. See
