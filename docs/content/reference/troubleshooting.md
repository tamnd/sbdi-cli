...
Most of these come down to network reality or how sbdi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sbdi rate-limits like any public site. sbdi already paces
...
Where a surface is gated, sbdi reads a cookie or token you supply
...
`sbdi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sbdi actually did
