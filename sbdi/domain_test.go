...
// HTTP behaviour is covered in sbdi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "sbdi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("sbdi", "about")
	if err != nil || got.String() != "sbdi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want sbdi://page/about", got.String(), err)
	}
}
